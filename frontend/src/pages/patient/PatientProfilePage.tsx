...
export function PatientProfilePage() {
  ...
  return <PatientLayout activeSection="profile" isLoggingOut={loggingOut} onAppointments={() => navigate('/patient/appointments')} onDashboard={() => navigate('/patient/home')} onLogout={signOut} onProfile={() => undefined} user={user}><div className="mx-auto max-w-5xl px-5 py-8 sm:px-8 lg:px-10">
